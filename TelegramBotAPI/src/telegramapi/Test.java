...
public class Test {
    ...
    public List<Message> getUpdate() throws IOException {
        List<Message> results = null;
        String jsonString = readJsonFromUrl("https://api.telegram.org/bot5219437388:AAG7PWHCynCCK5jGtEmeUpy6j6s1W-sI4ls/getUpdates");
